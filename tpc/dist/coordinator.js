...
define(["require", "exports", "immutable"], function (require, exports, immutable_1) {
    ...
    var Transaction = (function () {
        function Transaction(id, co) {
            this.id = id;
            this.co = co;
            this.state = 'Init';
            this.voters = immutable_1.List();
        ...
        Transaction.prototype.toWait = function () {
            var _this = this;
            this.state = 'Wait';
        ...
        Transaction.prototype.addVoter = function (p) {
            this.voters = this.voters.push(p);
        };
        Transaction.prototype.getVoters = function () {
            return this.voters;
        };
    ...
    var Coordinator = (function () {
        function Coordinator() {
            this.participants = immutable_1.List();
            this.transactions = immutable_1.Map();
        }
        Coordinator.prototype.addTransactionWithDefaultTimeout = function (id) {
            var tx = new Transaction(id, this);
            this.transactions = this.transactions.set(id, tx);
            return tx;
        };
        Coordinator.prototype.addTransaction = function (id, timeout) {
            var tx = this.addTransactionWithDefaultTimeout(id);
            tx.setTimeout(timeout);
            return tx;
        };
        Coordinator.prototype.joinParticpant = function (p) {
            var _this = this;
            this.participants = this.participants.push(p);
            this.participants.forEach(function (participant) {
                participant.updateOthers(_this.participants);
            });
        };
        Coordinator.prototype.startVote = function (txId) {
        ...
        Coordinator.prototype.voteCommit = function (p, txId) {
            var tx = this.transactions.get(txId);
            tx.addVoter(p);
            var allVoted = true;
            this.participants.forEach(function (pa) {
            ...
            if (allVoted) {
                tx.toCommit();
                this.participants.forEach(function (p1) {
                    p1.globalCommit(txId);
                });
            }
        };
        Coordinator.prototype.voteAbort = function (p, txId) {
            var tx = this.transactions.get(txId);
            tx.toAbort();
            this.participants.forEach(function (p1) {
                p1.globalAbort(txId);
        ...
        Coordinator.prototype.wait = function (txId) {
            return __awaiter(this, void 0, void 0, function () {
                var tx;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        Coordinator.prototype.transactionTimeout = function (tx) {
            tx.toAbort();
            this.participants.forEach(function (p1) {
